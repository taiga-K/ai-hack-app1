...
export function HomePage() {
  return (
    <div className="relative isolate min-h-dvh overflow-hidden bg-background">
      ...
      />
      <main className="motion-safe:animate-cute-enter relative mx-auto flex min-h-dvh w-full max-w-md flex-col justify-center gap-8 px-6 py-16">
        <div className="flex flex-col gap-3">
          <p className="text-sm font-medium text-foreground">会議のまとめ</p>
