...
- **Whispers.** Complementary **こちらのアドバイス** is visible. Text `専門用語が説明なく使われています` and `❓ 専門用語の確認` are visible. Suggested question `『API連携でリアルタイム同期』は、今ある画面を見るだけですか？` is visible.
